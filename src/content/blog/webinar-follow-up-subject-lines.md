...
1. **Name the deliverable in the subject line, not the body.** "Recording", "recap", "slides", "resource pack" — whichever asset you're sending, put its name in the subject line. Open rate doubles compared to "Thanks for joining us."

2. **Segment by attendance before you write copy.** An attendee getting "We missed you" feels wrong. A no-show getting "Thanks for joining us" feels wrong. The cost of maintaining two lists is zero; the upside is that every email reads like it was written for that person specifically.

3. **Short wins after day 3.** The first email can be descriptive and long (recording title, webinar name). By day 5–7, 4–8 words is the sweet spot. "Ready to try it?" — six words — outperforms "Thinking about implementing what we covered in our recent webinar?" every time.

## Get the full playbook

These subject lines are the shortest piece of the webinar sequence but they earn the opens that make everything else work. The body copy, segmentation logic, and CTA progression live in the full [13 webinar follow up email examples](/blog/webinar-follow-up-email) guide — that's where the sequence structure + real email bodies live.

If you want to see more of the source material, all 1,000+ emails are browsable by tag — [webinar-recording](/library/tag/webinar-recording) and [follow-up](/library/tag/follow-up) are good starting points.
