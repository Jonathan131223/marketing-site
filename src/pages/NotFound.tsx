    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <Link
            to="/blog"
            className="inline-flex items-center justify-center px-6 py-3 rounded-xl text-sm font-medium border border-slate-200 text-slate-700 hover:bg-slate-50 transition-colors"
          >
            Browse the blog
          </Link>
        </div>
