      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto">
            DigiStorms is trained on 1,000+ real SaaS emails from companies like
          </p>
        </div>
            ...
            <div className="flex animate-scroll gap-8">
              {[...Array(4)].map((_, setIndex) =>
                brandsLine1.map((brand, index) => (
                  <div key={`set-${setIndex}-${index}`} className="flex-shrink-0 flex items-center justify-center h-16">
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-gray-500">
            <a href="https://library.digistorms.ai/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 underline transition-colors">
