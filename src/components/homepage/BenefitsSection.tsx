...
const benefits: Benefit[] = [
  {
    ...
    visual: <img src="/benefits/benefit-2-new.webp" srcSet="/benefits/benefit-2-new-400w.webp 400w, /benefits/benefit-2-new-600w.webp 600w, /benefits/benefit-2-new-800w.webp 800w" alt="Journey from signup to upgrade" className="w-full h-auto object-contain" width="900" height="450" loading="lazy" sizes="(max-width: 768px) 100vw, 50vw" decoding="async" />,
    visualLeft: false,
  },
  {
    ...
    visual: <img src="/benefits/benefit-1-new.webp" srcSet="/benefits/benefit-1-new-400w.webp 400w, /benefits/benefit-1-new-600w.webp 600w, /benefits/benefit-1-new-800w.webp 800w" alt="Analyzing website to detect upgrade path" className="w-full h-auto object-contain" width="900" height="450" loading="lazy" sizes="(max-width: 768px) 100vw, 50vw" decoding="async" />,
    visualLeft: true,
  },
  {
    ...
    visual: <img src="/benefits/benefit-3-new.webp" srcSet="/benefits/benefit-3-new-400w.webp 400w, /benefits/benefit-3-new-600w.webp 600w, /benefits/benefit-3-new-800w.webp 800w" alt="Event triggers firing in real time" className="w-full h-auto object-contain" width="900" height="450" loading="lazy" sizes="(max-width: 768px) 100vw, 50vw" decoding="async" />,
    visualLeft: false,
  },
];
