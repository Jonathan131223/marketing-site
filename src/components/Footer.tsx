      ...
      <div className="container mx-auto px-4 py-16 pb-8">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <a
              href="https://www.foundrlist.com/product/digistorms?utm_source=badge&utm_medium=embed"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mt-4 opacity-60 hover:opacity-100 transition-opacity"
              aria-label="Featured on FoundrList"
            >
              <img
                src="https://www.foundrlist.com/api/badge/digistorms"
