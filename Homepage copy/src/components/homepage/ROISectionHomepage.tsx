    ...
    <section className="py-16 md:py-20 lg:py-24 bg-[#F8FAFC]">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-xl mx-auto">
          {/* Results — shown above the form once calculated */}
          {results && (
              ...
              {results.roi !== null && parseFloat(results.roi) >= 0 && (
                <>
                  ...
                  <div className="divide-y divide-gray-100 text-sm">
                    <div className="flex justify-between py-3">
                      ...
                      <span className="font-semibold text-gray-900">
                        {results.convRate}% → {results.newConvRate}%
                      </span>
                    </div>
                    <div className="flex justify-between py-3">
                      <span className="text-gray-500">Paid users/month</span>
                      <span className="font-semibold text-gray-900">
                        {formatNumber(results.baselinePaid)} → {formatNumber(results.newPaid)}
                      </span>
                    </div>
                    <div className="flex justify-between py-3">
                  ...
                  <p className="text-sm text-gray-500 text-center">
                    ...
                    <strong className="text-gray-900">${formatNumber(results.gain)}</strong> in revenue monthly,
                    an estimated <strong className="text-gray-900">{formatNumber(parseFloat(results.roi))}% ROI</strong> on a ${results.cost}/mo plan.
                  </p>

                  {/* URL capture — only visible once results are shown */}
