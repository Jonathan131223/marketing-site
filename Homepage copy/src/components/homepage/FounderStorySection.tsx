    ...
    <section className="py-16 md:py-20 lg:py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          {/* Profile image + heading stacked on mobile, side-by-side on sm+ */}
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              Before building this, I spent years helping SaaS companies improve their onboarding emails, the ones that actually activate users and turn them into paying customers.
            </p>

            <p>And I kept seeing the same problem:</p>

            <p>
              teams spend weeks writing and designing onboarding sequences, only to end up with something generic… or never launch them at all.
            </p>
      ...
      {/* Horizontally scrolling testimonials marquee */}
      <style
      ...
      <div className="mt-12 overflow-hidden w-full" style={{ paddingBottom: "2rem" }}>
        <div className="marquee-track" style={{ paddingLeft: "2rem" }}>
          ...
          <TestimonialMarqueeCard company="Blaze Type" industry="Font Solutions" quote="Jonathan's approach to retention has been a game-changer for us. Our customer lifetime value has significantly increased." author="Matthieu Salvaggio" color="bg-rose-500" logoUrl="/images-testimonials/blaze.png" avatarUrl="/images-testimonials/matt.jpeg" />
          <TestimonialMarqueeCard company="BryteBridge" industry="Non-Profit Solutions" quote="Jonathan is a rising star in Lifecycle Marketing and one of a few trusted freelancers I send referrals to. If you need help going 0 to 1 on your B2B SaaS lifecycle programs, give Jonathan a shout. His attitude, quality, and speed to delivery are all top-notch." author="Drew Price" color="bg-red-500" logoUrl="/images-testimonials/BryteBridge_Nonprofit_SolutionsWhite_Text_Navy_Background.jpg" avatarUrl="/images-testimonials/drew.jpeg" logoSizeClass="h-16 w-16" />
          <TestimonialMarqueeCard company="Magrid" industry="EdTech" quote="The team's expertise in email marketing transformed our user engagement metrics. We've never seen such positive results!" author="Tahereh Pazouki" color="bg-violet-500" logoUrl="/images-testimonials/magrid.webp" avatarUrl="/images-testimonials/tahereh.jpeg" />
          <TestimonialMarqueeCard company="Triscale" industry="GTM Expert" quote="I've had the pleasure of collaborating with Jonathan on several projects, and his expertise in lifecycle marketing for B2B SaaS is outstanding. He deeply understands how to drive engagement and retention through smart, data-driven campaigns. Beyond his skills, he's a fantastic partner. Insightful, proactive, and always focused on impact. I highly recommend working with him!" author="Thibault Le Meur" color="bg-gray-700" logoUrl="/images-testimonials/triscale.jpeg" avatarUrl="/images-testimonials/thibault.jpeg" />
