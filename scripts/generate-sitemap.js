...
const staticEntries = [
  ...
  urlEntry(`${BASE_URL}/blog/behavior-based-vs-time-based-emails`, "2026-05-22", "monthly", "0.9"),
  ...
  urlEntry(`${BASE_URL}/blog/customer-retention-email-examples`,    "2026-05-11", "monthly", "0.9"),
